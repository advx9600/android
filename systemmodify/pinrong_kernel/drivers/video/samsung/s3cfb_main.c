...
static int s3cfb_probe(struct platform_device *pdev)
{
	...
	gpio_direction_output(EXYNOS4212_GPM2(4), 0);//lvds
	gpio_direction_output(EXYNOS4212_GPM2(3), 0);//lcd_vdd
	//gpio_direction_output(EXYNOS4_GPD0(1), 0);
	msleep(100);
	gpio_direction_output(EXYNOS4212_GPM2(3), 1);//lcd_vdd
	mdelay(50);
	gpio_direction_output(EXYNOS4212_GPM2(4), 1);//lvds
	mdelay(200);	
	//gpio_direction_output(EXYNOS4_GPD0(1), 0);
