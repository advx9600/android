...
#include <linux/dm9000.h>  //add rongpin
...
#ifdef CONFIG_VIDEO_RPCAMERA
static struct rp2055_platform_data rp2055_plat = {
	.default_width = 640,
	.default_height = 480,
...
static struct i2c_board_info rp2055_i2c_info = {
	I2C_BOARD_INFO("rp5065", 0x1f),
	.platform_data = &rp2055_plat,
};

static struct s3c_platform_camera rp2055 = {
#if 1
...
//	I2C_BOARD_INFO("rptvp5150", 0xb8 >> 1),
...
#endif
#if defined(CONFIG_VIDEO_TVP5151)
	.default_cam	= CAMERA_PAR_B,	
#endif
	.camera		= {
#ifdef CONFIG_VIDEO_S5K4BA
...
static struct dw_mci_board exynos_dwmci_pdata __initdata = {
	...
	.caps			= MMC_CAP_UHS_SDR50 | MMC_CAP_1_8V_DDR |
...
static struct s5m_platform_data exynos4_s5m8767_pdata = {
	...
	.buck_gpios[0]		= EXYNOS4_GPL0(2),
	.buck_gpios[1]		= EXYNOS4_GPL0(2),
	.buck_gpios[2]		= EXYNOS4_GPL0(2),

	.buck_ds[0]		= EXYNOS4_GPL0(2),
	.buck_ds[1]		= EXYNOS4_GPL0(2),
...
#define S5P_PA_DM9000        EXYNOS4_PA_SROM_BANK(1) //add rongpin
static struct resource smdkv210_dm9000_resources[] = {
	...
	[2] = {
		.start	= IRQ_EINT(5),
		.end	= IRQ_EINT(5),
		.flags	=IORESOURCE_IRQ | IORESOURCE_IRQ_HIGHLEVEL ,  // IORESOURCE_IRQ | IRQF_TRIGGER_LOW,
	},
};
...
#ifdef CONFIG_REGULATOR_MAX8647

#include <linux/regulator/max8647.h>

static struct regulator_consumer_supply MAX8647_ldo6_consumer =
	REGULATOR_SUPPLY("vdd_alive", NULL);
static struct regulator_consumer_supply MAX8647_buck2_consumer =
	REGULATOR_SUPPLY("vdd_arm", NULL);
static struct regulator_consumer_supply MAX8647_buck3_consumer =
	REGULATOR_SUPPLY("vdd_g3d", NULL);
static struct regulator_consumer_supply MAX8647_buck4_consumer =
	REGULATOR_SUPPLY("vdd_int", NULL);
static struct regulator_consumer_supply MAX8647_DCDC_consumer =
	REGULATOR_SUPPLY("vdd_mif", NULL);
static struct regulator_consumer_supply MAX8647_buck1_consumer =
	REGULATOR_SUPPLY("VDD_MEM", NULL);
static struct regulator_consumer_supply MAX8647_ldo5_consumer =
	REGULATOR_SUPPLY("VDD_PLL", NULL);


static struct regulator_init_data MAX8647_ldo5_data = {
	.constraints	= {
		.name		= "VDD_PLL",
		.min_uV		= 1100000,
		.max_uV		= 1100000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &MAX8647_ldo5_consumer,	
};

static struct regulator_init_data MAX8647_ldo6_data = {
	.constraints	= {
		.name		= "VDD_ALIVE",
		.min_uV		= 1000000,
		.max_uV		= 1000000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &MAX8647_ldo6_consumer,	
};

static struct regulator_init_data MAX8647_buck1_data = {
	.constraints	= {
		.name		= "vdd_mem range",
		.min_uV		= 1200000,
		.max_uV		= 1300000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &MAX8647_buck1_consumer,
};

static struct regulator_init_data MAX8647_buck2_data = {
	.constraints = {
		.name = "vdd_arm range",
		.min_uV = 800000,
		.max_uV = 1350000,
	...
	.num_consumer_supplies = 1,
	.consumer_supplies = &MAX8647_buck2_consumer,
};

static struct regulator_init_data MAX8647_buck3_data = {
	.constraints = {
		.name = "vdd_g3d range",
		.min_uV = 850000,
		.max_uV = 1200000,
	...
	.num_consumer_supplies = 1,
	.consumer_supplies = &MAX8647_buck3_consumer,
};

static struct regulator_init_data MAX8647_buck4_data = {
	.constraints = {
		.name = "vdd_int range",
		.min_uV = 800000,
		.max_uV = 1150000,
	...
	.num_consumer_supplies = 1,
	.consumer_supplies = &MAX8647_buck4_consumer,
};

static struct regulator_init_data MAX8647_DCDC_data = {
	.constraints	= {
		.name		= "vdd dummy",
		.min_uV = 850000,
		.max_uV = 1200000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &MAX8647_DCDC_consumer,	
};


static struct MAX8647_regulator_subdev MAX8647_regulators[] = {
	{ MAX8647_DCDC1, &MAX8647_buck1_data },
	{ MAX8647_DCDC2, &MAX8647_buck2_data },
	{ MAX8647_DCDC3, &MAX8647_buck3_data },
	{ MAX8647_DCDC4, &MAX8647_buck4_data },
	{ MAX8647_LDO5,   &MAX8647_ldo5_data },
	{ MAX8647_LDO6,   &MAX8647_ldo6_data },
	{ MAX8647_DCDC, &MAX8647_DCDC_data }, 	
};

struct MAX8647_platform_data max8647_data = {
	.num_regulators = ARRAY_SIZE(MAX8647_regulators),
	.regulators     =MAX8647_regulators,
};
...
#ifdef CONFIG_REGULATOR_MAX8647
	{
		I2C_BOARD_INFO("max8647", 0x5A),
		.platform_data = &max8647_data,
	},
#endif
};
...
static void __init smdk4x12_smsc911x_init(void)
{
	...
	unsigned int tmp;
     ...
     void __iomem	* GPY0CON;
     void __iomem	* SROMBW;
     void __iomem	* SROMBC1;

	GPY0CON=ioremap(0x11000120, 4);
	SROMBW=ioremap(SROM_BW, 4);
	SROMBC1=ioremap(SROM_BC1, 4);
	
		
      tmp = readl(GPY0CON);
      tmp |= (2 << 4);
	__raw_writel(tmp, GPY0CON); 
	...
	writel((0x1 << S5P_SROM_BCX__PMC__SHIFT) |
		     ...
		     (0x6 << S5P_SROM_BCX__TACC__SHIFT) |
		     (0x1 << S5P_SROM_BCX__TCOS__SHIFT) |
		     (0x1 << S5P_SROM_BCX__TACS__SHIFT), SROMBC1);   
...
static void __init smdk4x12_machine_init(void)
{
	...
	gpio_direction_output(EXYNOS4_GPX0(2), 1);//3G
